...
const __pageData = JSON.parse('{"title":"Pointing Device","description":"","frontmatter":{},"headers":[],"relativePath":"features/pointing_device.md","filePath":"features/pointing_device.md","lastUpdated":1789015193000}');
const _sfc_main = { name: "features/pointing_device.md" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    createStaticVNode("", 224)
  ])]);
}
