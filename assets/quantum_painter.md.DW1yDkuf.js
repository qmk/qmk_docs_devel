...
const __pageData = JSON.parse('{"title":"Quantum Painter","description":"","frontmatter":{},"headers":[],"relativePath":"quantum_painter.md","filePath":"quantum_painter.md","lastUpdated":1789015193000}');
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[60] || (_cache[60] = createStaticVNode('<h2 id="quantum-painter-api" tabindex="-1">Quantum Painter Drawing API <a class="header-anchor" href="#quantum-painter-api" aria-label="Permalink to &quot;Quantum Painter Drawing API {#quantum-painter-api}&quot;">​</a></h2><p>All APIs require a <code>painter_device_t</code> object as their first parameter -- this object comes from the specific device initialisation, and instructions on creating it can be found in each driver&#39;s respective section.</p><p>To use any of the APIs, you need to include <code>qp.h</code>:</p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">#include</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &lt;qp.h&gt;</span></span></code></pre></div>', 4)),
    createVNode(_component_PluginTabs, null, {
      default: withCtx(() => [
